...
dada_junkdb -b $[85858560*20] -g -m 0 -s 10000 -k 0x1234 test_header1
echo Observation 1 sent

echo populating with junk 16 seconds worth of 1 sec data
dada_junkdb -b $[85858560*16] -g -m 0 -s 10000 -k 0x1234 test_header2
